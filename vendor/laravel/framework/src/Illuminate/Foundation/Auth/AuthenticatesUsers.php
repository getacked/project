...
trait AuthenticatesUsers
{
    ...
    public function login(Request $request)
    {
        ...
        if($credientials_verified) {
            ...
            if (Auth::guard($this->getGuard())->attempt($credentials, $request->has('remember'))) {
                ...
                return $this->sendEmailUnverifiedResponse($request);
            }
        }
     ...
     * @return \Illuminate\Http\Response
     */
    public function sendEmailUnverifiedResponse(Request $request) {
    ...
    protected function getEmailUnverifiedMessage()
    {
        return Lang::has('auth.unverified')
                ...
                : 'Your email has not been verified.  Please verify your email to access your account. <br> Not received link? <a href="' 
